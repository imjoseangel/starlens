...
[🎬 Watch the demo video](https://github.com/imjoseangel/starlens/blob/devel/docs/demo.m4v)

<!-- Replace with {% embed https://youtube.com/watch?v=XXXX %} once uploaded to YouTube -->

## Code

{% github imjoseangel/startlens %}
